	...
	<div class="container-fluid">
		...
		<div id="main" class="main">
			...
			<header id="header" class="masthead">
				...
				<div class="center">
					...
					<nav>
						<ul>
	                    	<li>
	                            <a href="sportsnews-basketball.php">Sportnews</a>
	                        </li>
			...
			<div class="content">
				...
				<!-- Banner -->
				<div class="banner basketball"> <!-- add sport name to class to link background image -->
				...
				<div class="copy">
					...
					<div class="center">
						...
						<div class="col-full">
							...
							<h1 class="title">Basketball Livescores</h1>

							<div class="text">
								
								<p>Sei bei jedem Korb und jedem Dunk live dabei mit den<br />
								  ...
								  <ul class="slides">
								    ...
								    <li>
								    	...
								    	<div class="slide">
								    		...
								    		<div class="screenshot basketball livescores apple-live"></div>
								    		<div class="screenshot basketball livescores android-games"></div>
								    ...
								    <li>
								    	...
								    	<div class="slide">
								    		...
								    		<div class="screenshot basketball livescores apple-games"></div>
								    		<div class="screenshot basketball livescores android-live"></div>
						...
						<div class="col-half text">
							...
							<h3>BASKETBALL LIVESCORES</h3>
							<p>Ablenkung vom Alltag bekommst Du nur, wenn in der NBA ein paar Körbe geworfen
							werden? Hol Dir die Basketball Livescores auf Dein Smartphone: Die Livescores App hält
							alle aktuellen Nachrichten aus der Welt des Basketballs für Dich bereit.
							Mit <strong class="bibname">Bet <span class="red">IT</span>
							Best</strong> bist Du immer up to date.</p>
							...
							<div class="text">
								<a target="_blank" class="homelink" href="https://www.betitbest.com/livescores/de/basketball">Hier gehts zu unserer Webseite</a>
