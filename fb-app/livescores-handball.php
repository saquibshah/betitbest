	...
	<div class="container-fluid">
			...
			<ul class="sidebar-navigation" role="sidebar-navigation">
				...
				<li>
					<a href="livescores-rugby.php">
						<span class="icon">
							<img src="assets/img/icons/icon-rugby.png" alt="football">
						</span>
		...
		<div id="main" class="main">
			...
			<header id="header" class="masthead">
				...
				<div class="center">
					...
					<nav>
						<ul>
	                    	<li>
	                            <a href="sportsnews-handball.php">Sportnews</a>
	                        </li>
			...
			<div class="content">
				...
				<!-- Banner -->
				<div class="banner handball"> <!-- add sport name to class to link background image -->
				...
				<div class="copy">
					...
					<div class="center">
						<div class="col-full">
							...
							<h1 class="title">Handball Livescores</h1>

							<div class="text">
								
								<p>Verpasse keinen Pass, keinen Wurf, kein Tor mit den<br />
								<strong>Bet <span class="red">IT</span> Best Livescores</strong>!</p>
								  ...
								  <ul class="slides">
								    ...
								    <li>
								    	...
								    	<div class="slide">
								    		...
								    		<div class="screenshot handball livescores apple-live"></div>
								    		<div class="screenshot handball livescores android-games"></div>
								    ...
								    <li>
								    	...
								    	<div class="slide">
								    		...
								    		<div class="screenshot handball livescores apple-games"></div>
								    		<div class="screenshot handball livescores android-live"></div>
						...
						<div class="col-half text">
							...
							<h3>HANDBALL LIVESCORES</h3>
							<p>Handball ist Deine Lieblingssportart? Mit der praktischen
							Livescores App kannst Du Dich auch von unterwegs aus und rund um die Uhr zu den
							neuesten Ergebnissen auf dem Laufenden halten. <strong class="bibname">Bet <span class="red">IT</span>
							Best</strong> liefert Dir umfassende Informationen zur
							Handball WM, dem DHB Pokal und der Handball Bundesliga. Bequem informieren mit <strong class="bibname">Bet <span class="red">IT</span>
							Best</strong>.</p>
							...
							<div class="text">
								<a target="_blank" class="homelink" href="https://www.betitbest.com/livescores/de/handball">Hier gehts zu unserer Webseite</a>
