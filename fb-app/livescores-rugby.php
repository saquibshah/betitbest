	...
	<div class="container-fluid">
		...
		<div id="main" class="main">
			...
			<div class="content">
				...
				<!-- Banner -->
				<div class="banner rugby"> <!-- add sport name to class to link background image -->
				...
				<div class="copy">
					...
					<div class="center">
						...
						<div class="col-full">
							...
							<h1 class="title">Rugby Livescores</h1>

							<div class="text">
								
								<p>Erlebe jeden Versuch und jede Erhöhung mit den<br />
								  ...
								  <ul class="slides">
								    ...
								    <li>
								    	...
								    	<div class="slide">
								    		...
								    		<div class="screenshot rugby livescores apple-live"></div>
								    		<div class="screenshot rugby livescores android-games"></div>
								    ...
								    <li>
								    	...
								    	<div class="slide">
								    		...
								    		<div class="screenshot rugby livescores apple-games"></div>
								    		<div class="screenshot rugby livescores android-live"></div>
						...
						<div class="col-half text">
							...
							<h3>RUGBY LIVESCORES</h3>
							<p>Livescores zum Rugby erhältst Du schnell und bequem mit der <strong class="bibname">Bet <span class="red">IT</span>
							Best</strong> App. Kostenlos
							laden und immer auf dem neuesten Stand bleiben. Wenn es zum Tackling auf dem Feld
							kommt, wirst Du erst richtig warm? Dann halt Dich mit Ergebnissen von der Rugby WM,
							Rugby Bundesliga und mehr jederzeit und rund um die Uhr auf dem Laufenden.</p>
							...
							<div class="text">
								<a target="_blank" class="homelink" href="https://www.betitbest.com/livescores/de/home">Hier gehts zu unserer Webseite</a>
