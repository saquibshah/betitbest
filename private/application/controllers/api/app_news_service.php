 ...
 *
 */
class App_news_service extends CI_Controller {
    ...
    public function get_news() {
        ...
        $this->load->model('app_news_model', 'app_news_model', true);
        ...
        $only_localized = rawurldecode(utf8_decode($this->input->get('only_localized'))) ? true : false;
        ...
        //Get data return
        $out->status = 'success';
        $out->result = $this->app_news_model->get_sports_news($only_localized, $page * 20, $limit = 20, $teamBetradarIds, $tournamentBetradarIds, $categoryBetadarIDs, $sportBetradarIDs, $mark_time);
        return $this->response($out, 200);
    }
