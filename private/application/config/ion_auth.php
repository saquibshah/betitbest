 ...
 */
$config['site_title']                 = "Bet IT Best GmbH";       // Site Title, example.com
$config['admin_email']                = "admin@betitbest.com"; // Admin Email, admin@example.com
$config['default_group']              = 'verwaltung';           // Default group, use name
$config['admin_group']                = 'administratoren';             // Default administrators group, use name
