...
/**
 * Class Ion_auth
 * @method Ion_auth_model user(int $id = null)
 * @method bool login(string $identity, string $password, bool $remember = false)
 * @method string messages()
 * @method bool activate(int $id, bool $code = false)
 * @method bool change_password(string $identity, string $old, string $new);
 * @method string errors()
 * @method bool create_group(string $group_name = false, string $group_description = '', array $additional_data =
 *     array())
 * @method bool deactivate(int $id = null)
 * @method Ion_auth_model group(int $id = null)
 * @method Ion_auth_model groups()
 * @method Ion_auth_model where(string $where, string $value = null)
 * @method Ion_auth_model users(mixed $groups = null)
 * @method array errors_array(bool $langify = true)
 * @method Ion_auth_model get_users_groups(int $id = false)
 * @method bool delete_user(int $id)
 */
class Ion_auth
{
	/**
