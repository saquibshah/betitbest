    ...
    Custom = (function () {
        ...
        checkTables = function () {
            ...
            if ($('#tournamenttable').length) {
                setupDataTable('#tournamenttable', '/backend/tournament/getAsync', {
                    aaSorting: [[1, "asc"]],
            ...
            if ($('#logtable').length) {
                setupDataTable('#logtable', '/backend/log/getAsync', {
                    aaSorting: [[0, "desc"]],
        ...
        checkEditables = function () {
            ...
            if ($('#saveNavSorting').length) {
                ...
                $('#saveNavSorting').click(function () {
                    ...
                    $.post("/backend/frontend/reorder_nav", {
                        data: data
                    }, function (data) {
                        bootbox.alert(data);
                    });
            ...
            */
            $('#blacklistselect').select2({
                placeholder: "Keyword eingeben", minimumInputLength: 2, allowClear: true, multiple: true, ajax: {
                    url: "/backend/keyword/getBlacklistDropdown",
                    dataType: 'json',
                    quietMillis: 250,
            ...
            $("#keywordselect").select2({
                placeholder: "Keyword eingeben", minimumInputLength: 2, allowClear: true, ajax: {
                    url: "/backend/keyword/getKeywordDropdown",
                    dataType: 'json',
                    quietMillis: 250,
                    data: function (term, page) {
                        return {
            ...
            $("#teamSelect, #teamSelect2").select2({
                placeholder: "Mannschaft w&auml;hlen", minimumInputLength: 2, allowClear: true, ajax: {
                    url: "/backend/team/getTeamDropdown",
                    dataType: 'json',
                    quietMillis: 250,
                    data: function (term, page) {
                        return {
