...
--
-- Host: 127.0.0.1
-- Generation Time: May 21, 2015 at 04:38 PM
...
--
-- Table structure for table `sportnews_livescores_rugby`
--

CREATE TABLE IF NOT EXISTS `sportnews_livescores_rugby` (
...
--
-- Indexes for table `sportnews_livescores_rugby`
--
ALTER TABLE `sportnews_livescores_rugby`
