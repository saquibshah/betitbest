...
--
-- Host: 127.0.0.1
-- Generation Time: May 21, 2015 at 03:57 PM
...
--
-- Table structure for table `sportnews_livescores_handball`
--

CREATE TABLE IF NOT EXISTS `sportnews_livescores_handball` (
  ...
  `timezone` varchar(45) COLLATE latin1_german2_ci DEFAULT NULL,
...
--
-- Indexes for table `sportnews_livescores_handball`
--
ALTER TABLE `sportnews_livescores_handball`
