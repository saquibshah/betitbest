...
--
-- Host: 127.0.0.1
-- Generation Time: May 21, 2015 at 03:55 PM
...
--
-- Table structure for table `sportnews_livescores_football`
--

CREATE TABLE IF NOT EXISTS `sportnews_livescores_football` (
  ...
  `q4_scorehome` int(2) DEFAULT NULL,
  `q4_scoreaway` int(2) DEFAULT NULL,
...
--
-- Indexes for table `sportnews_livescores_football`
--
ALTER TABLE `sportnews_livescores_football`
