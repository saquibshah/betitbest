...
--
-- Table structure for table `sportnews_livescores_basketball`
--

CREATE TABLE IF NOT EXISTS `sportnews_livescores_basketball` (
  ...
  `q1_scorehome` int(3) DEFAULT NULL,
  `q1_scoreaway` int(3) DEFAULT NULL,
  `q2_scorehome` int(3) DEFAULT NULL,
  `q2_scoreaway` int(3) DEFAULT NULL,
  `q3_scorehome` int(3) DEFAULT NULL,
  `q3_scoreaway` int(3) DEFAULT NULL,
  `q4_scorehome` int(3) DEFAULT NULL,
  `q4_scoreaway` int(3) DEFAULT NULL,
  `ot_scorehome` int(3) DEFAULT NULL,
  `ot_scoreaway` int(3) DEFAULT NULL,
...
--
-- Indexes for table `sportnews_livescores_basketball`
--
ALTER TABLE `sportnews_livescores_basketball`
