...
$basketball_lkl=0;
$basketball_abl=0;
$basketball_nbapreseason=0;
$basketball_plk=0;
$basketball_ligaaba=0;
...
$result=mysql_query("SELECT league FROM `ls_matches_basketball` where `matchdate`< '$spielanzeige' AND `matchdate` > '$spielanzeige_after' ORDER BY `league`");
while ($line = mysql_fetch_array($result)){
	if ($line[league]=="BBL") {$basketball_bbl=1;}
	else if ($line[league]=="FIBA World Championship, Women, Knockout stage") {$basketball_fiba=1;}
	else if ($line[league]=="Ligan") {$basketball_ligan=1;}
	else if ($line[league]=="LKL") {$basketball_lkl=1;}
	else if ($line[league]=="ABL") {$basketball_abl=1;}
	else if ($line[league]=="NBA Preseason") {$basketball_nbapreseason=1;}
	else if ($line[league]=="PLK") {$basketball_plk=1;}
	else if ($line[league]=="Liga ABA") {$basketball_ligaaba=1;}
	else if ($line[league]=="NBA") {$basketball_nba=1;}
...
if($basketball_bbl==1){
$result=mysql_query("SELECT country, league, matchid, matchdate, matchstatus, hometeam, awayteam, scorehome, scoreaway, q1_scorehome, q1_scoreaway, q2_scorehome, q2_scoreaway, q3_scorehome, q3_scoreaway, q4_scorehome, q4_scoreaway, ot_scorehome, ot_scoreaway, winner, winnername, uniqueTeamHome, uniqueTeamAway, lastteamscored FROM `ls_matches_basketball` where `league` = 'BBL' AND `matchstatus` != 'Cancelled' AND `matchdate`< '$spielanzeige' AND `matchdate` > '$spielanzeige_after' ORDER BY `matchdate` asc limit 16");
?>
...
<?php
		...
		while ($line = mysql_fetch_array($result)){
			...
			<tr class="ls_first_player_row" style="height:32px"><span >
				...
				echo  "<span style=\"display:block;cursor:pointer;\" data-myDescr=\"https://ls.betradar.com/ls/livescore/?/betitbest/de/page/lmts_frame#matchid_".$line[matchid]."\">".$line[q4_scorehome]."</span>";
				?>
				</td>
			...
			<tr class="ls_second_player_row" style="height:32px"><span >
				...
				echo  "<span style=\"display:block;cursor:pointer;\" data-myDescr=\"https://ls.betradar.com/ls/livescore/?/betitbest/de/page/lmts_frame#matchid_".$line[matchid]."\">".$line[q4_scoreaway]."</span>";
				?>
				</td>
...
if($basketball_nbapreseason==1){
$result=mysql_query("SELECT country, league, matchid, matchdate, matchstatus, hometeam, awayteam, scorehome, scoreaway, q1_scorehome, q1_scoreaway, q2_scorehome, q2_scoreaway, q3_scorehome, q3_scoreaway, q4_scorehome, q4_scoreaway, ot_scorehome, ot_scoreaway, winner, winnername, uniqueTeamHome, uniqueTeamAway, lastteamscored FROM `ls_matches_basketball` where `league` = 'NBA Preseason' AND `matchstatus` != 'Cancelled' AND `matchdate`< '$spielanzeige' AND `matchdate` > '$spielanzeige_after' ORDER BY `matchdate` asc limit 16");
?>
<div id="test" class="testclosebutton"><a href="#"><== close MatchApp</a></div>
<table id="ls_table"
<?php
		...
		while ($line = mysql_fetch_array($result)){
			...
			?>
				<tr><th class="ls_tournament_header" colspan="8">
				<?php
				if ($line[league]=="NBA Preseason"){echo "NBA Preseason";};
				$league_already1=1;
			?>
				</th></tr>
			<?php
...
if($basketball_lkl==1){
$result=mysql_query("SELECT country, league, matchid, matchdate, matchstatus, hometeam, awayteam, scorehome, scoreaway, q1_scorehome, q1_scoreaway, q2_scorehome, q2_scoreaway, q3_scorehome, q3_scoreaway, q4_scorehome, q4_scoreaway, ot_scorehome, ot_scoreaway, winner, winnername, uniqueTeamHome, uniqueTeamAway, lastteamscored FROM `ls_matches_basketball` where `league` = 'LKL' AND `matchstatus` != 'Cancelled' AND `matchdate`< '$spielanzeige' AND `matchdate` > '$spielanzeige_after' ORDER BY `matchdate` asc limit 16");
?>
<div id="test" class="testclosebutton"><a href="#"><== close MatchApp</a></div>
<table id="ls_table"
<?php
		...
		while ($line = mysql_fetch_array($result)){
			...
			?>
				<tr><th class="ls_country_header" colspan="8">
				<?php
				if ($line[country]=="Lithuania"){echo "Lithuania";};
				$country_already2=1;
			?>
				</th></tr>
			<?php
...
//start NBA
if($basketball_nba==1){
$result=mysql_query("SELECT country, league, matchid, matchdate, matchstatus, hometeam, awayteam, scorehome, scoreaway, q1_scorehome, q1_scoreaway, q2_scorehome, q2_scoreaway, q3_scorehome, q3_scoreaway, q4_scorehome, q4_scoreaway, ot_scorehome, ot_scoreaway, winner, winnername, uniqueTeamHome, uniqueTeamAway, lastteamscored FROM `ls_matches_basketball` where `league` = 'NBA' AND `matchstatus` != 'Cancelled' AND `matchdate`< '$spielanzeige' AND `matchdate` > '$spielanzeige_after' ORDER BY `matchdate` asc limit 16");
?>
<div id="test" class="testclosebutton"><a href="#"><== close MatchApp</a></div>
<table id="ls_table"
<?php
...
if($basketball_==1){
$result=mysql_query("SELECT country, league, matchid, matchdate, matchstatus, hometeam, awayteam, scorehome, scoreaway, q1_scorehome, q1_scoreaway, q2_scorehome, q2_scoreaway, q3_scorehome, q3_scoreaway, q4_scorehome, q4_scoreaway, ot_scorehome, ot_scoreaway, winner, winnername, uniqueTeamHome, uniqueTeamAway, lastteamscored FROM `ls_matches_basketball` where `league` = '' AND `matchstatus` != 'Cancelled' AND `matchdate`< '$spielanzeige' AND `matchdate` > '$spielanzeige_after' ORDER BY `matchdate` asc limit 16");
?>
<div id="test" class="testclosebutton"><a href="#"><== close MatchApp</a></div>
<table id="ls_table"
<?php
