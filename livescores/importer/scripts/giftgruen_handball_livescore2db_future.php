...
if (file_exists($xmlFile)) { 
	...
	/*
										...
										$logname="/opt/users/www/betitbest-news/livescores/importer/log/handball_import_main_xml2db.log";
				...
				foreach ($sport->children() as $category) {
					...
					if($category->Name=="Germany" || $category->Name=="Sweden" || $category->Name=="Denmark" || $category->Name=="Norway" || $category->Name=="Spain" || $category->Name=="International Clubs" || $category->Name=="England" || $category->Name=="Turkey" || $category->Name=="Italy" || $category->Name=="International" || $category->Name=="Argentina" || $category->Name=="Australia" || $category->Name=="Austria" || $category->Name=="Belgium" || $category->Name=="Denmark" || $category->Name=="France" || $category->Name=="Germany Amateur" || $category->Name=="Greece" || $category->Name=="Holland" || $category->Name=="Mexico" || $category->Name=="Portugal" || $category->Name=="Russia" || $category->Name=="Scotland" || $category->Name=="Switzerland" || $category->Name=="Ukraine" || $category->Name=="USA" ){
						...
						$UniqueTournamentId2db=$UniqueTournamentId['UniqueTournamentId'];
							if($LigaId['BetradarTournamentId']=="720" || $LigaId['BetradarTournamentId']=="2780" || $LigaId['BetradarTournamentId']=="2781" || $LigaId['BetradarTournamentId']=="2782" || $LigaId['BetradarTournamentId']=="2783" || $LigaId['BetradarTournamentId']=="1733" || $LigaId['BetradarTournamentId']=="17974" || $LigaId['BetradarTournamentId']=="17975" || $LigaId['BetradarTournamentId']=="17976" || $LigaId['BetradarTournamentId']=="17977" || $LigaId['BetradarTournamentId']=="17978" || $LigaId['BetradarTournamentId']=="4105" || $LigaId['BetradarTournamentId']=="4106" || $LigaId['BetradarTournamentId']=="4042" || $LigaId['BetradarTournamentId']=="4043" || $LigaId['BetradarTournamentId']=="4044" || $LigaId['BetradarTournamentId']=="4045" || $LigaId['BetradarTournamentId']=="282" || $LigaId['BetradarTournamentId']=="19107" || $LigaId['BetradarTournamentId']=="29092" || $LigaId['BetradarTournamentId']=="913" || $LigaId['BetradarTournamentId']=="9025" || $LigaId['BetradarTournamentId']=="9026" || $LigaId['BetradarTournamentId']=="9027" || $LigaId['BetradarTournamentId']=="9028" || $LigaId['BetradarTournamentId']=="9029" || $LigaId['BetradarTournamentId']=="9030" || $LigaId['BetradarTournamentId']=="13179" || $LigaId['BetradarTournamentId']=="13181" || $LigaId['BetradarTournamentId']=="13182" || $LigaId['BetradarTournamentId']=="217" || $LigaId['BetradarTournamentId']=="2465" || $LigaId['BetradarTournamentId']=="2466" || $LigaId['BetradarTournamentId']=="2467" || $LigaId['BetradarTournamentId']=="2468" || $LigaId['BetradarTournamentId']=="11036" || $LigaId['BetradarTournamentId']=="11037" || $LigaId['BetradarTournamentId']=="133" || $LigaId['BetradarTournamentId']=="95" || $LigaId['BetradarTournamentId']=="212" || $LigaId['BetradarTournamentId']=="99" || $LigaId['BetradarTournamentId']=="157" || $LigaId['BetradarTournamentId']=="114" || $LigaId['BetradarTournamentId']=="5420"){
								...
								*/
								...
								if($teamnamehome=="" || $teamnameaway=="" || $matchId2db<10){}
									...
									//$logname="main_xml2db.log";
										...
										//fclose($datei);
									/*	
									$checkrows = mysql_query("SELECT `matchid` FROM `sportnews_livescores_handball` where `matchid` = '$matchId2db' Limit 1");
									echo mysql_errno(),
									"<br>",
									mysql_error();
									...
									if ($num_rows<1){
									mysql_query("INSERT INTO `sportnews_livescores_handball` (matchid, leagueid,country,league,matchdate,matchstatus,hometeam,awayteam,lastperioddate,scorehome,scoreaway,lastgoaltime, uniqueTeamHome, uniqueTeamAway, lastgoalteam, scoremin, scoredby, createtime,lastchangeby,xmltime) VALUES ('$matchId2db','$LigaId','$country', '$league', '$m_timestamp','$status','$teamnamehome','$teamnameaway','$p_timestamp','$scorehome','$scoreaway','$lastgoaltime','$uniqueTeamIdHome2db','$uniqueTeamIdAway2db','$lastgoalteam', '$minscored','$lastgoalscoredby','$jetzt','future','$xmltime') ON DUPLICATE KEY 
