...
echo time()."- start importing livescores.\n";
  if (file_exists($xmlFile)) { 
			...
			$logname="/opt/users/www/betitbest-news/livescores/importer/log/soccer_import_future_xml2db.log";
