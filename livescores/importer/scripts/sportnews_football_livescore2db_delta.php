...
//HIER SCORING/SERVING ÄNDERN																		
								...
								if($teamnamehome=="" || $teamnameaway=="" || $matchId2db<10){}
									...
									if ($num_rows<1){
									mysql_query("INSERT INTO `sportnews_livescores_football` (matchid, leagueid, categoryid, uniquetournamentid, country, league, matchdate, matchstatus, hometeam, awayteam, uniqueTeamHome, uniqueTeamAway, scorehome, scoreaway, q1_scorehome, q1_scoreaway, q2_scorehome, q2_scoreaway, q3_scorehome, q3_scoreaway, q4_scorehome, q4_scoreaway, ot_scorehome, ot_scoreaway, winner, winnername, lastteamscored, createtime, lastchangeby) VALUES ('$matchId2db', '$LigaId', '$CategoryId', '$UniqueTournamentId2db', '$country', '$league', '$m_timestamp','$status','$teamnamehome','$teamnameaway','$uniqueTeamIdHome2db','$uniqueTeamIdAway2db','$scorehome','$scoreaway', '$p1_home', '$p1_away', '$p2_home', '$p2_away', '$p3_home', '$p3_away', '$p4_home', '$p4_away', '$ot_home', '$ot_away', '$winner', '$winnername', '$lastscoring', '$jetzt', 'delta') ON DUPLICATE KEY 
									...
									else if($row[matchstatus]=="Not started" && $status=="1st quarter" || $row[matchstatus]=="1st quarter" && $status=="2nd quarter" || $row[matchstatus]=="2nd quarter" && $status=="3rd quarter" || $row[matchstatus]=="3rd quarter" && $status=="4th quarter" || $row[matchstatus]=="3rd quarter" && $status=="4th quarter" || $row[matchstatus]=="4th quarter" && $status=="Ended"  || $row[matchstatus]=="4th quarter" && $status=="Overtime" || $row[matchstatus]=="4th quarter" && $status=="Awaiting extra time" || $row[matchstatus]=="Overtime" && $status=="AET"){
