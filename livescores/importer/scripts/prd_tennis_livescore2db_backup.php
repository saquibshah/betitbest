...
$xmlFile='/opt/users/www/betitbest/xmls/sportradar/lct/livescore_multicast_betitbest_lct_4250.xml';
...
//																					$pointattr=$satzergebnis->Point[$countpoints]->attributes();
								...
								if($teamnamehome=="" || $teamnameaway=="" || $matchId2db<10){}
									...
									mysql_query("INSERT INTO `ls_matches_tennis` (matchid, league, tournament, matchdate, matchstatus, hometeam, awayteam, scorehome, scoreaway, p1_scorehome, p1_scoreaway, p2_scorehome, p2_scoreaway, p3_scorehome, p3_scoreaway, p4_scorehome, p4_scoreaway, p5_scorehome, p5_scoreaway, uniqueTeamHome, uniqueTeamAway, lastgoalteam, servingplayer, pointhome, pointaway, lastchangeby, xmltime) VALUES ('$matchId2db', '$country', '$league', '$m_timestamp','$status','$teamnamehome','$teamnameaway','$scorehome','$scoreaway', '$p1_home', '$p1_away', '$p2_home', '$p2_away', '$p3_home', '$p3_away', '$p4_home', '$p4_away', '$p5_home', '$p5_away','$uniqueTeamIdHome2db','$uniqueTeamIdAway2db', '$lastscoring', '$actserving', '$pointhome','$pointaway','main', $xmltime) ON DUPLICATE KEY 
									...
									$checkrows = mysql_query("SELECT `matchid` FROM `ls_matches_tennis` where `matchid` = '$matchId2db' AND '$xmltime' > `xmltime` Limit 1");
									echo mysql_errno(),
									"<br>",
									mysql_error();
