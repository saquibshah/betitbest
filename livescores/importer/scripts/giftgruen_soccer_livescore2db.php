		...
		foreach( $sports as $sport ){
			...
			if ($name=="Soccer" ){
				...
				foreach ($catagoryNames as $categories){
					...
					if($category=="Germany" || $category=="International Champions Cup" || $category=="Cyprus" || $category=="Spain" || $category=="International Clubs" || $category=="England" || $category=="Turkey" || $category=="Italy" || $category=="International" || $category=="Argentina" || $category=="Australia" || $category=="Austria" || $category=="Belgium" || $category=="Denmark" || $category=="France" || $category=="Germany Amateur" || $category=="Greece" || $category=="Netherlands" || $category=="Mexico" || $category=="Portugal" || $category=="Russia" || $category=="Scotland" || $category=="Switzerland" || $category=="Ukraine" || $category=="USA" ){
						$country=$category;
							...
							if($LigaId=="42" || $LigaId=="66" || $LigaId=="16277" || $LigaId=="10771" || $LigaId=="29019" || $LigaId=="10772" || $LigaId=="838" || $LigaId=="41" || $LigaId=="23" || $LigaId=="10909" || $LigaId=="36" || $LigaId=="1" || $LigaId=="16" || $LigaId=="8343" || $LigaId=="43" || $LigaId=="150" || $LigaId=="62" || $LigaId=="33" || $LigaId=="86"|| $LigaId=="16527"|| $LigaId=="10910"|| $LigaId=="680"|| $LigaId=="6456"|| $LigaId=="3959"|| $LigaId=="1339"|| $LigaId=="3948"  || $LigaId=="1462"  || $LigaId=="1463"  || $LigaId=="1464"  || $LigaId=="1465"  || $LigaId=="1466"  || $LigaId=="1467"  || $LigaId=="1468"  || $LigaId=="1469"  || $LigaId=="10908"  || $LigaId=="10911"  || $LigaId=="10912"  || $LigaId=="10913"  || $LigaId=="10914"  || $LigaId=="10915"  || $LigaId=="10916"  || $LigaId=="10917"  || $LigaId=="10918"  || $LigaId=="10919"  || $LigaId=="10920"  || $LigaId=="10921"  || $LigaId=="4508" || $LigaId=="4509" || $LigaId=="4510" || $LigaId=="4511" || $LigaId=="4512" || $LigaId=="4513" || $LigaId=="4514" || $LigaId=="5346" || $LigaId=="5347" || $LigaId=="68" || $LigaId=="29" || $LigaId=="38" || $LigaId=="12" || $LigaId=="4" || $LigaId=="21299" || $LigaId=="44" || $LigaId=="21301" || $LigaId=="21300" || $LigaId=="8364" || $LigaId=="127" || $LigaId=="39" || $LigaId=="28" || $LigaId=="52" || $LigaId=="53" || $LigaId=="54" || $LigaId=="1060" || $LigaId=="384" || $LigaId=="18" || $LigaId=="17" || $LigaId=="144" || $LigaId=="689" || $LigaId=="387"){
								...
								foreach ($matches as $match){
									...
									if(($match->getElementsByTagName( 'MatchDate' )->item(0)->nodeValue)!="" && ($homeTeam->item(0)->nodeValue)!="" && ($awayTeam->item(0)->nodeValue)!=""){
										...
										$live_match_query = mysql_query("SELECT * FROM `sportnews_livescores_soccer` where `matchstatus` = '1st half' || `matchstatus` = '2nd half' || `matchstatus` = 'Halftime'  || `matchstatus` = '1st extra'  || `matchstatus` = '2nd extra' ");
										
										while($row = mysql_fetch_array($live_match_query)){
											$match_id = $row['matchid'];
											if ($match_id!=$matchId2db){
												echo "LCA match ID:".$match_id."<br/>";
												//$status_update_query = mysql_query("UPDATE sportnews_livescores_soccer SET matchstatus='LCA' WHERE matchid='$match_id'");
											}
										}
										//end LCA check
										*/
