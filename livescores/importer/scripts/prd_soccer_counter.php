...
//$xmlFile='xmls/sportradar/ls_(18-02-15)_(18-29)/livescore_betitbest.xml';
//echo time()."<br>";
$generatedFor="";
$xmlcounter=0;
...
mysql_query("SET NAMES 'utf8'");
	...
	if($xml) { 
					...
					if($xmlcounter>$counterValueFromDB && $counterValueFromDB!=""){
						echo "<br>New Counter value is greater than old Counter value<br>";
					}
					
					if ($xmlcounter>($counterValueFromDB+1)){
						mysql_query("INSERT INTO `ls_matches_soccer_counter` (generatedFor, counter, lastchangeby) VALUES ('$generatedFor', '$xmlcounter', 'main') ON DUPLICATE KEY 
