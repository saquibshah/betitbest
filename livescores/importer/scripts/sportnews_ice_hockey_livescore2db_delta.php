...
//HIER SCORING/SERVING ÄNDERN																		
								...
								if($teamnamehome=="" || $teamnameaway=="" || $matchId2db<10){}
									...
									else if($row[matchstatus]=="Not started" && $status=="1st period" || $row[matchstatus]=="1st period" && $status=="2nd period" || $row[matchstatus]=="2nd period" && $status=="3rd period" || $row[matchstatus]=="1st period" && $status=="Halftime" || $row[matchstatus]=="2nd period" && $status=="Halftime" || $row[matchstatus]=="3rd period" && $status=="Ended" || $row[matchstatus]=="3rd period" && $status=="Extra time" || $row[matchstatus]=="Extra time" && $status=="AET" || $row[matchstatus]=="Extra time" && $status=="Penalties" || $row[matchstatus]=="Penalties" && $status=="AP" ){
