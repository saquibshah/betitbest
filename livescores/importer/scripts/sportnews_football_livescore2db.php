...
//HIER SCORING/SERVING ÄNDERN																		
								...
								if($teamnamehome=="" || $teamnameaway=="" || $matchId2db<10){}
									...
									else if($row[matchstatus]=="Not started" && $status=="1st quarter" || $row[matchstatus]=="1st quarter" && $status=="2nd quarter" || $row[matchstatus]=="2nd quarter" && $status=="3rd quarter" || $row[matchstatus]=="3rd quarter" && $status=="4th quarter" || $row[matchstatus]=="4th quarter" && $status=="Overtime" || $row[matchstatus]=="Overtime" && $status=="Ended" || $row[matchstatus]=="4th quarter" && $status=="Ended" || $row[matchstatus]=="1st quarter" && $status=="Pause" || $row[matchstatus]=="2nd quarter" && $status=="Pause" || $row[matchstatus]=="3rd quarter" && $status=="Pause" || $row[matchstatus]=="4th quarter" && $status=="Pause" || $row[matchstatus]=="Pause" && $status=="1st quarter" || $row[matchstatus]=="Pause" && $status=="2nd quarter" || $row[matchstatus]=="Pause" && $status=="3rd quarter" || $row[matchstatus]=="Pause" && $status=="4th quarter"  ){
