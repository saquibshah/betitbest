...
//																		$pointattr=$satzergebnis->Point[$countpoints]->attributes();
		...
		//HIER SCORING/SERVING ÄŽDERN																		
								...
								if($teamnamehome=="" || $teamnameaway=="" || $matchId2db<10){}
									...
									$checkrows = mysql_query("SELECT * FROM `ls_matches_football_test` where `matchid` = '$matchId2db' AND `lastchangeby`='delta' Limit 1");
									if ($checkrows!=""){
