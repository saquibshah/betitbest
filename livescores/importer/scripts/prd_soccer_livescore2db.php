...
$lcaProcess->setTable('ls_matches_soccer');
  ...
  if (file_exists($xmlFile)) { 
	...
	mysql_query($query);
  	...
  	if ($doc) {
		...
		$query=mysql_query("SELECT counter FROM ls_matches_soccer WHERE xmltime='$xmltime' LIMIT 1");
