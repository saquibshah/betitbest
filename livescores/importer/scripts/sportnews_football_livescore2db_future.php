...
if (file_exists($xmlFile)) { 
	...
	$eintragen=date('d.M.Y-H:i:s',time())." - delta_xml Datei vorhanden.\nBeginne Verarbeitung..";
										$logname="/opt/users/www/betitbest-news/livescores/importer/log/football_import_main_xml2db.log";
				...
				foreach ($sport->children() as $category) {
					...
					if($category->Name=="USA" || $category->Name=="Canada"){
						...
						$UniqueTournamentId2db=$UniqueTournamentId['UniqueTournamentId'];
							if($LigaId['BetradarTournamentId']=="621" || $LigaId['BetradarTournamentId']=="14249" || $LigaId['BetradarTournamentId']=="25622" || $LigaId['BetradarTournamentId']=="47" || $LigaId['BetradarTournamentId']=="9956" || $LigaId['BetradarTournamentId']=="6344" || $LigaId['BetradarTournamentId']=="994"){
...
//HIER SCORING/SERVING ÄNDERN																		
								...
								if($LigaId=="47"){$league="NFL";}
								else if ($LigaId=="6344"){$league="NFL Preseason";}
								else if ($LigaId=="994"){$league="NFL Pro Bowl";}
								else if ($LigaId=="621"){$league="CFL";}
								else if ($LigaId=="14249"){$league="CFL, Playoffs";}
								else if ($LigaId=="25622"){$league="CFL, Pre-Season";}
								...
								if($teamnamehome=="" || $teamnameaway=="" || $matchId2db<10){}
									...
									mysql_query("INSERT INTO `sportnews_livescores_football` (matchid, leagueid, categoryid, uniquetournamentid, country, league, matchdate, matchstatus, hometeam, awayteam, uniqueTeamHome, uniqueTeamAway, scorehome, scoreaway, q1_scorehome, q1_scoreaway, q2_scorehome, q2_scoreaway, q3_scorehome, q3_scoreaway, q4_scorehome, q4_scoreaway, ot_scorehome, ot_scoreaway, winner, winnername, lastteamscored, createtime, lastchangeby, xmltime) VALUES ('$matchId2db', '$LigaId', '$CategoryId', '$UniqueTournamentId2db', '$country', '$league', '$m_timestamp','$status','$teamnamehome','$teamnameaway','$uniqueTeamIdHome2db','$uniqueTeamIdAway2db','$scorehome','$scoreaway', '$p1_home', '$p1_away', '$p2_home', '$p2_away', '$p3_home', '$p3_away', '$p4_home', '$p4_away', '$ot_home', '$ot_away', '$winner', '$winnername', '$lastscoring', '$jetzt', 'future', '$xmltime') ");
									echo mysql_errno(),
									"<br>",
									mysql_error();									
									//$logname="main_xml2db.log";
										...
										//fclose($datei);
									/*	
									$checkrows = mysql_query("SELECT `matchid` FROM `sportnews_livescores_football` where `matchid` = '$matchId2db' Limit 1");
									echo mysql_errno(),
									"<br>",
									mysql_error();
									...
									if ($num_rows<1){
									mysql_query("INSERT INTO `sportnews_livescores_football` (matchid, leagueid, country, league, matchdate, matchstatus, hometeam, awayteam, uniqueTeamHome, uniqueTeamAway, scorehome, scoreaway, q1_scorehome, q1_scoreaway, q2_scorehome, q2_scoreaway, q3_scorehome, q3_scoreaway, q4_scorehome, q4_scoreaway, ot_scorehome, ot_scoreaway, winner, winnername, lastteamscored, createtime, lastchangeby, xmltime) VALUES ('$matchId2db', '$LigaId', '$country', '$league', '$m_timestamp','$status','$teamnamehome','$teamnameaway','$uniqueTeamIdHome2db','$uniqueTeamIdAway2db','$scorehome','$scoreaway', '$p1_home', '$p1_away', '$p2_home', '$p2_away', '$p3_home', '$p3_away', '$p4_home', '$p4_away', '$ot_home', '$ot_away', '$winner', '$winnername', '$lastscoring', '$jetzt', 'future', '$xmltime') ON DUPLICATE KEY 
